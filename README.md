This project is an end-to-end pipeline that uses AWS SageMaker, S3, and Lambda to train and deploy a machine learning model for cryptocurrency price monitoring.  
